				...
				<div className='grid grid-cols-4 gap-5  p-5'>
					{visa.map((item) => (
						<div className='p-5 relative group' key={item.id}>
							...
							<div className='details-button flex justify-center items-center absolute top-1/2 left-1/2 -mt-16 transform -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out'>
								<Button variant={'outline'} className=' font-semibold text-xl '>
									<BookUser className='text-orange-600 pr-4 w-12 h-12' />
									Details
								</Button>
							</div>
						</div>
